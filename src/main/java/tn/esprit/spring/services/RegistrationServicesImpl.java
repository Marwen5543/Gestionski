...
public class RegistrationServicesImpl implements  IRegistrationServices{
    ...
    public Registration addRegistrationAndAssignToSkier(Registration registration, Long numSkieur) {
        Skier skier = skierRepository.findById(numSkieur)
                .orElseThrow(() -> new RuntimeException("Skier not found")); // Handle not found
    ...
    public Registration assignRegistrationToCourse(Long numRegistration, Long numCourse) {
        ...
        return registrationRepository.save(registration); // Save the registration with the course assigned.
    }
